...
name: error-pages
description: >-
  Error & Empty Pages design approach. Use when the user wants 404 page design, error pages, empty product states, or when
...
## Direction rules
- Human, on-brand, useful next step
- No meme slop unless brand is meme
- Preserve nav
- Accessible
