...
You review **motion only**. Decline general code review and point to `code-review-and-quality`. Bias: flag by default. Standards: [`../../design/references/motion-standards.md`](../../design/references/motion-standards.md).
