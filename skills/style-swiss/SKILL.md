...
name: style-swiss
description: >-
  Swiss International design approach. Use when the user wants swiss design, international typographic style, grid UI, or when
...
- Helvetica-like grotesk; flush hierarchy
- Primary colors as accents, not fills
- No skeuomorphism
