...
name: steer-animate
description: >-
  Steer: Animate design approach. Use when the user wants animate UI command, add purposeful motion, or when
...
## Direction rules
- Hand off to motion-craft rules
- Purpose + frequency first
- GPU props only
- Review with review-motion
