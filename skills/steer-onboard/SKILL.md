...
name: steer-onboard
description: >-
  Steer: Onboard design approach. Use when the user wants onboard UX, empty state design, activation path, or when
