...
description: >-
  Hero Discipline design approach. Use when the user wants hero section rules, landing first viewport, brand hero, or when
...
## Direction rules
- Brand + one headline + one support + one CTA + one visual
- Full-bleed; no overlays
- No stats in first viewport
- Brand test without nav
