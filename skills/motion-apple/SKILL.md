...
name: motion-apple
description: >-
  Apple-like Motion design approach. Use when the user wants apple design motion, fluid interface, WWDC-like animation web, or when
...
## Direction rules
- Fluid continuity; shared-element thinking
- Soft springs for gestures
- Respect reduced-motion
- Translate to CSS/WAAPI/web, don’t cargo-cult iOS APIs
