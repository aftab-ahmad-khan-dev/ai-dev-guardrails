...
name: steer-clarify
description: >-
  Steer: Clarify design approach. Use when the user wants clarify copy, UX writing, CTA verbs, or when
...
- Specific CTAs
- Plain language
- Kill vague headlines
- Match brand voice in PRODUCT.md
