...
name: style-terminal
description: >-
  Terminal / Developer design approach. Use when the user wants terminal UI, developer aesthetic, monospace product shell, or when
...
## Direction rules
- Mono for data; clear density controls
- Dark-first OK if contrast holds
- No fake matrix rain
- Keyboard-first; motion almost none
