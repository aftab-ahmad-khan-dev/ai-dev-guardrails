...
/frontend-ui-engineering
# or ask the agent:
use skill frontend-ui-engineering
```
...
For taste, anti-slop direction, steer commands, and motion craft, use the design pack: `design/using-design-skills` → `anti-slop-frontend` / `design-steer` / `motion-craft` (see `design/README.md`).
