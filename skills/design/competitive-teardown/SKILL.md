...
description: >-
  Competitive Visual Teardown design approach. Use when the user wants competitor UI teardown, visual analysis, design research, or when
  using-design-skills routes to this approach.
---

# Competitive Visual Teardown
...
# or ask the agent:
use skill competitive-teardown
```
...
## Direction rules
- Screenshot → patterns table
- What to steal / avoid
- Map to our PRODUCT.md
- No cloning trademarked assets
