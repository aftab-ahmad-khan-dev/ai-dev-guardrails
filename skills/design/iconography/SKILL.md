...
name: iconography
description: >-
  Iconography System design approach. Use when the user wants icon system, consistent icons, SVG iconography UI, or when
...
## Direction rules
- One icon set; optical alignment
- No emoji as primary icons
- Drop rounded-square icon tiles above every H2
- Accessible titles
