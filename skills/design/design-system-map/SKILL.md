...
description: >-
  Design System Map design approach. Use when the user wants pick design system, material vs polaris vs shadcn, system mapping, or when
...
## Direction rules
- Inherit repo system first
- Map brief → Material/Fluent/Carbon/Polaris/Primer/GOV/Radix/shadcn/native
- Don’t mix three systems
- Document choice in DESIGN.md
