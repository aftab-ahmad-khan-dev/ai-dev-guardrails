...
name: steer-bolder
description: >-
  Steer: Bolder design approach. Use when the user wants make UI bolder, amplify weak design, stronger visual, or when
...
## Direction rules
- Increase contrast/type punch
- Keep identity; don’t rebrand
- Hero must pass brand test
- Avoid glow/neon crutches
