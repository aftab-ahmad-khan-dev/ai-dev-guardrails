---
name: gpt-strict-taste
description: >-
  Strict Taste (GPT/Codex) design approach. Use when the user wants strict taste for GPT, Codex frontend rules, stronger anti-slop, or when
  using-design-skills routes to this approach.
---

# Strict Taste (GPT/Codex)
...
## Direction rules
- Stronger layout variance required
- Ban ghost-cards + over-rounding
- Force brief inference written aloud
