...
name: social-proof
description: >-
  Social Proof Craft design approach. Use when the user wants testimonials design, logos cloud, social proof section, or when
...
## Direction rules
- Credible quotes; real names/roles when allowed
- Logo walls quiet
- No fake star spam
- One proof job per section
