---
name: style-consumer-mobile
description: >-
  Consumer Mobile Web design approach. Use when the user wants mobile-first consumer UI, thumb-friendly web app, or when
...
```text
/style-consumer-mobile
# or ask the agent:
use skill style-consumer-mobile
```
...
## Direction rules
- Thumb zones; 44px targets
- Bottom nav sparingly
- Full-bleed media OK
