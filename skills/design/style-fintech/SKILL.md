...
name: style-fintech
description: >-
  Fintech Trust design approach. Use when the user wants fintech UI, banking design, money product interface, or when
...
## Direction rules
- Tabular nums; stable layouts (no CLS)
- Trust blues/greens earned, not purple
- Clear destructive confirms
- Motion subtle
