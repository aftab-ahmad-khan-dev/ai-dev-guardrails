...
name: motion-gesture
description: >-
  Gesture & Drag Motion design approach. Use when the user wants gesture animation, drag interactions, swipe dismiss, or when
...
- Finger tracking > keyframes
- Spatial exit = enter reverse
