...
name: style-data-viz
description: >-
  Data Visualization UI design approach. Use when the user wants data viz UI, chart-heavy dashboard, analytics design, or when
...
## Direction rules
- Chart first; chrome second
- Colorblind-safe palettes
- Empty/loading for every chart
- No card-in-card around every widget
