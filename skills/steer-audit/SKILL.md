...
name: steer-audit
description: >-
  Steer: Audit design approach. Use when the user wants design audit, a11y audit UI, responsive quality check, or when
...
## Direction rules
- Headings, contrast, focus, targets
