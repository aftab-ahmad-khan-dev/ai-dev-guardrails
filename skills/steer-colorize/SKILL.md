...
name: steer-colorize
description: >-
  Steer: Colorize design approach. Use when the user wants colorize UI, brand color pass, tint neutrals, or when
...
## Direction rules
- Strategic accent; tint neutrals
- Dual-mode parity
- No purple default cluster
- Semantic status colors labeled
