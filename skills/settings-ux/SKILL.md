...
name: settings-ux
description: >-
  Settings UX design approach. Use when the user wants settings page design, preferences UI, account settings, or when
...
- Immediate save vs explicit save — pick one
- Search when large
