...
Taste in motion is mostly subtraction. Animate only when purpose and frequency allow; then pick curve, duration, origin, and interruptibility deliberately. Standards: [`../references/motion-standards.md`](../references/motion-standards.md).
