...
Full index: [`approaches/README.md`](../approaches/README.md) · Safety: [`SAFETY.md`](../SAFETY.md)
...
5. Run the [slop catalog](../references/slop-catalog.md) before claiming UI is done.
