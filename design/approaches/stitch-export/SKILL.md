...
name: stitch-export
description: >-
  Stitch / DESIGN.md Export design approach. Use when the user wants stitch export, DESIGN.md portable, design tokens document, or when
...
## Direction rules
- Write portable DESIGN.md
- Semantic tokens
- Component inventory
- Readable by other DESIGN.md tools
