...
description: >-
  Dark Mode Protocol design approach. Use when the user wants dark mode design, dual theme parity, theme tokens, or when
...
## Direction rules
- Dual-mode by default when product themes
- Hierarchy parity; not inverted greys only
- Tint surfaces; avoid pure #000/#fff
- Test both before ship
