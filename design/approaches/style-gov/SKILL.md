...
name: style-gov
description: >-
  Public Sector Clarity design approach. Use when the user wants government UI, public sector design, accessible civic interface, or when
...
## Direction rules
- Inherit USWDS/GOV.UK if present
- Plain language; high contrast
- No trend-chasing chrome
- WCAG AA+
