...
name: steer-typeset
description: >-
  Steer: Typeset design approach. Use when the user wants typeset, typography hierarchy, font pairing UI, or when
...
## Direction rules
- Purposeful fonts; avoid Inter/Arial defaults on brand
