---
name: style-neo-brutal
description: >-
  Neo-Brutal design approach. Use when the user wants neo-brutalism, thick borders, flat color blocks, playful hard UI, or when
...
## Direction rules
- Thick borders; flat fills; hard offsets (not soft shadows)
- Bold type; limited palette
- Interactive affordances obvious
- Keep a11y contrast
