...
name: steer-layout
description: >-
  Steer: Layout design approach. Use when the user wants fix layout, spacing rhythm, visual alignment, or when
...
- Spacing scale only
- Alignment + proximity
- Density for Operate; air for Persuade
- Kill nested cards
