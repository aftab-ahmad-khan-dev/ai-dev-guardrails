...
description: >-
  Dashboard Operate Mode design approach. Use when the user wants dashboard design, operate mode, dense app shell, or when
  using-design-skills routes to this approach.
---

# Dashboard Operate Mode
