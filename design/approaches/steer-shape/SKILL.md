...
name: steer-shape
description: >-
  Steer: Shape design approach. Use when the user wants shape UX before code, plan UI structure, or when
...
## Direction rules
- No code until plan approved (unless user says build)
- Wire hierarchy + anti-refs
- Name surface mode
- Exit: outline + next skill
