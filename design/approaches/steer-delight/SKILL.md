...
name: steer-delight
description: >-
  Steer: Delight design approach. Use when the user wants delight moments, micro-joy UI, celebratory feedback, or when
...
## Direction rules
- Rare + justified only
- Frequency gate (motion-craft)
- Reduced-motion fallback
- Never on 100+/day actions
